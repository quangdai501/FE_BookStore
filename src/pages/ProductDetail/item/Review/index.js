  ...
  return (
    <div className="row shadow">
      <div className="col c-6 md-12 review">
        <h3 className="review-title">Đánh Giá - Nhận Xét Từ Khách Hàng</h3>
        {reviews !== undefined && reviews.length > 0 ? (
          reviews.map((item, index) => <Comment key={index} review={item} />)
        ) : (
          <div className="row center-item review-none">
      ...
      <div className="col c-6 md-12 write-review">
        ...
        {userInfo?.email ? (
          <>
            <div className="row rating member">
              ...
              {[1, 2, 3, 4, 5].map((item) => {
                if (item <= ratingNumber) {
                  ...
                  return (
                    <p className="star" onClick={() => onChangeRating(item)}>
                      <i class="fas fa-star"></i>
                    </p>
                  );
                }
            ...
            <p>
              <span className="title-text">Nhận xét:</span>
              <textarea type="text" onChange={onChangeComment} />
            </p>
            <button className="btn btn--border-none" onClick={sendReview}>
              Gửi đánh giá {props.loading ? "..." : ""}
            </button>
          </>
        ) : (
          <div className="client">
            ...
            <div className="row">
              ...
              <div className="c-6 lg-12 md-12">
                ...
                <Link to="/register" className="link link--underline">
                  Đăng ký
                </Link>
              </div>
            </div>
